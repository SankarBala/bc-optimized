...
<head>
    ...
    <meta name="description" content="Bengal Consultancy Website" />
...
<body onscroll="bodyScrolled()">
                                            ...
                                            @foreach ($countries as $country)
                                                <li>
                                                    <a href="{{ route('showCountry', $country->name) }}">
                                                        ...
                                                        <img src="{{ Storage::url('uploads/thumbnails/30x20/' . basename($country->national_flag)) }}"
                                                            alt="" width="24px" height="18px" />
                                            ...
                                            @foreach ($populars as $popular)
                                                <li>
                                                    <a href="{{ route('popular', $popular->name) }}">
                                                        ...
                                                        <img src="{{ Storage::url('uploads/thumbnails/30x20/' . basename($popular->national_flag)) }}"
                                                            alt="" width="24px" height="18px" />
    ...
    <a href="https://wa.me/+8801944555500" target="_blank" class="whatsapp-btn">
        <img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg" width="80px" height="80px" alt="WhatsApp">
    </a>
